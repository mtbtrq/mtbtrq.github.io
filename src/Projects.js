...
function Projects() {
    return (
        <>
            <h1 id="mainProjectsTitle">My Projects</h1>
            <ul id="projectUl">
                <li><a className="project" href="https://github.com/mutyyab/URLShortener">A URL Shortener</a></li>
                <li><a className="project" href="https://github.com/mutyyab/Weather">A Weather Application</a></li>
                <li><a className="project" href="https://github.com/mutyyab/CryptoPrices">A Crypto Price Checker</a></li>
                <li><a className="project" href="https://github.com/mutyyab/SelfMadeBot">A Self Made Discord Bot</a></li>
                <li><a className="project" href="https://github.com/mutyyab/TabOpener">A Chrome Extension (TabOpener)</a></li>
                <li><a className="project" href="https://github.com/mutyyab/Bloop">A Discord bot made using Python</a></li>
